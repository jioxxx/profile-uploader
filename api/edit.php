    ...
    <form method="POST" enctype="multipart/form-data">
      ...
      <div class="card">
        ...
        <div class="av-box" onclick="document.getElementById('avatar').click()">
          <img id="av-preview"
            src="<?= isset($p['avatar']) && $p['avatar'] ? (strpos($p['avatar'], 'data:image') === 0 ? $p['avatar'] : 'uploads/avatars/' . htmlspecialchars($p['avatar'])) : 'https://ui-avatars.com/api/?name=' . urlencode($p['name']) . '&background=2d6a4f&color=fff&size=144' ?>"
            alt="preview">
